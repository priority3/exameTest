...
export default function DeleteSourceButton(props: { sourceId: string }) {
  ...
  const performDelete = useCallback(async () => {
    ...
    setError(null);
    try {
      const res = await fetch(`${apiBase}/sources/${props.sourceId}`, {
        method: "DELETE",
      });
  ...
  return (
    <>
      ...
      <ConfirmDialog
        open={showConfirm}
        title="删除 Source"
        message="确定要删除此 Source 吗？关联的所有 Paper、题目、作答记录等都将被永久删除，此操作不可撤销。"
